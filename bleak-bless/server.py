...
async def run(loop):
    ...
    MANUFACTURER_NAME_UUID = "00002A29-0000-1000-8000-00805F9B34FB".lower()
    MODEL_NUMBER_UUID = "00002A24-0000-1000-8000-00805F9B34FB".lower()
    SERIAL_NUMBER_UUID = "00002A25-0000-1000-8000-00805F9B34FB".lower()
    HARDWARE_REVISION_UUID = "00002A27-0000-1000-8000-00805F9B34FB".lower()
    FIRMWARE_REVISION_UUID = "00002A26-0000-1000-8000-00805F9B34FB".lower()
    SOFTWARE_REVISION_UUID = "00002A28-0000-1000-8000-00805F9B34FB".lower()
    SYSTEM_ID_UUID = "00002A23-0000-1000-8000-00805F9B34FB".lower()
    ...
    DATA_IMAGES_CHAR = await server.add_new_characteristic(
        str(SERVICE_DATA_IMAGES_UUID),
        str(DATA_IMAGES_UUID),
